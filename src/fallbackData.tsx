      ...
      pdpModels: [
        {
          ...
          pdpModel: {
            imageURLs: {
              ...
              description: 'Add links to images, videos like youtube, vimeo, etc.',
              displayOnUI: true,
            },
            brand: {
              name: 'Brand',
            ...
            variants: {
              ...
              type: 'array',
              description:
                'Manage product variants like colors, sizes, or add custom options to give customers more choices.',
              displayOnUI: true,
              value: [
                {
                  bDefault: {
                    ...
                    type: 'boolean',
                    value: false,
                    description: 'Set this variant as default',
                    displayOnUI: true,
                  },
                  variant_id: {
                    name: 'Variant ID',
                  ...
                  short_description: {
                    ...
                    type: 'string',
                    value: 'Camera short description',
                  ...
                  long_description: {
                    ...
                    description: 'Long description of the variant',
                    displayOnUI: true,
                  },
                  in_stock: {
                    name: 'In Stock',
                    type: 'boolean',
                    value: false,
                    description: 'Is the variant in stock?',
                    displayOnUI: true,
                  },
                  available_stock: {
                    ...
                    type: 'number',
                    value: 0,
                    description: 'Available stock of the variant',
                    displayOnUI: true,
                  },
                  retail_price: {
                    name: 'Retail Price',
                  ...
                  imageURLs: {
                    ...
                    description: 'Add images of the variant, must be a valid image URL',
                    displayOnUI: true,
                  },
                  variants: [
                    {
            ...
            market: {
              ...
              type: 'string',
              value: '',
              description: 'Market of the product',
              displayOnUI: true,
            },
            short_description: {
            ...
            variants_selection_order: {
              ...
              type: 'stringArray',
              value: [],
              description: 'Order of the variants',
              displayOnUI: true,
            },
            default_url: {
              name: 'Default URL',
              type: 'url',
              value: 'https://images.pexels.com/photos/674010/pexels-photo-674010.jpeg',
              description: 'Default URL of the product',
              displayOnUI: true,
            },
            tags: {
              name: 'Tags',
            ...
            turnTableURL: {
              ...
              type: 'url',
              value: '',
              description: 'Turn Table URL of the product, must be a valid URL',
              displayOnUI: true,
            },
          },
        },
                  ...
                  variants: [
                    ...
                    },
                    {
                      ...
                      imageURLs: {
                        ...
                        type: 'urlArray',
                        value: [
                          'https://images.pexels.com/photos/30668789/pexels-photo-30668789/free-photo-of-close-up-of-pink-camera-outdoors-in-belem.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                          'https://images.pexels.com/photos/16562449/pexels-photo-16562449/free-photo-of-pink-35-mm-camera.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                        ],
                        description: 'Add images of the variant, must be a valid image URL',
                        displayOnUI: true,
                      },
                    },
                    {
                      ...
                      imageURLs: {
                        ...
                        type: 'urlArray',
                        value: [
                          'https://images.pexels.com/photos/2600128/pexels-photo-2600128.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                          'https://images.pexels.com/photos/2634435/pexels-photo-2634435.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                        ],
                        description: 'Add images of the variant, must be a valid image URL',
                        displayOnUI: true,
                      },
